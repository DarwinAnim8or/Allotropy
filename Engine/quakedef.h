...
#define ALLOTROPY_VERSION 0.19         //GieV: <release>.<version, increases for every new feature>.<patch number>
#define ALLOTROPY_VERSION_PATCH 2
...
#define VMODELS_ENABLED         0   //GieV: If enabled, will allow the usage of VMDLs.
